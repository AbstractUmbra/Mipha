...
# reveal_type(foo1)
# reveal_type(foo1.__call__)
# reveal_type(foo1.cache)
# reveal_type(foo1.get_key)
# reveal_type(foo1.invalidate)
# reveal_type(foo1.get_stats)
# reveal_type(foo1.invalidate_containing)
...
# reveal_type(foo2)
# reveal_type(foo2.__call__)
# reveal_type(foo2.cache)
# reveal_type(foo2.get_key)
# reveal_type(foo2.invalidate)
# reveal_type(foo2.get_stats)
# reveal_type(foo2.invalidate_containing)


# @cache(strategy=Strategy.timed)
# async def foo3(a: int, b: int) -> int:
#     return a + b

# reveal_type(foo3)
# reveal_type(foo3.__call__)
# reveal_type(foo3.cache)
# reveal_type(foo3.get_key)
# reveal_type(foo3.invalidate)
# reveal_type(foo3.get_stats)
# reveal_type(foo3.invalidate_containing)
...
# def foo4(a: int, b: int) -> int:
#     return a + b

# reveal_type(foo4)
# reveal_type(foo4.__call__)
# reveal_type(foo4.cache)
# reveal_type(foo4.get_key)
# reveal_type(foo4.invalidate)
# reveal_type(foo4.get_stats)
# reveal_type(foo4.invalidate_containing)
